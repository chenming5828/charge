...
typedef actionlib::SimpleActionClient<charge_localization_and_move::chargeAction> goalClient;
...
charge_localization_and_move::posewithscan charge_station;

charge_localization_and_move::posewithscan pair_goal;
...
void doChargeCallBack(std_msgs::Bool msg)
{
    if(msg.data)
    {
        ...
        if(has_charge_goal)
        {
            ...
            charge_localization_and_move::chargeGoal send_goal;
